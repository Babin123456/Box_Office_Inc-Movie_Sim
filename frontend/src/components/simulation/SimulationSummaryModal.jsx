  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-xl bg-[#111827] border border-slate-800 rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
        <div className="bg-linear-to-r from-violet-600 to-indigo-600 p-5 sm:p-8 text-center relative">
          <button
            onClick={onClose}
        ...
        <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2 max-h-36 sm:max-h-48 overflow-y-auto pr-2 custom-scrollbar">
